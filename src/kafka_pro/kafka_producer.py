...
# # Loading Kafka Cluster/Server details from configuration file(databuilding_app.conf)
# def waiting_broker(self, *args, **kwargs):
# check layer 
...
if __name__ == "__main__":
    ...
    product_name_list = ["Laptop", "Desktop Computer", "Mobile Phone", "Wrist Band", "Wrist Watch", "LAN Cable",
                         "HDMI Cable", "TV", "TV Stand", "Text Books", "External Hard Drive", "Online Course"]

    order_card_type_list = ['Visa', 'Master', 'Maestro', 'American Express', 'Cirrus', 'PayPal']

    country_name_city_name_list = [
                                   "Manouba,Tunisia", "Mjez el bab,Tunisia","sidinasser,tunisia"  ,"Florida,United States", "New York City,United States",
                                   "Paris,France", "Colombo,Sri Lanka", "Dhaka,Bangladesh"
                                ]

    ecommerce_website_name_list = [ "www.amazon.com", "www.alibaba.com", "www.ebay.com"]
